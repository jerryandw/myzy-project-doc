...
<div class="detail_page">
    <div class="titleBox" @click="goPageFun">
            ...
            <div class="titleContent">患者添加</div>
    </div>
	...
	<div class="contentBox">
		<ul>
				<li @click="toEditFun('name')">
					<div class="titleBox1">姓名</div>
					<div class="inputBox">
						<span>{{name}}</span>
						<img class="iconNext" src="../../../images/mingyi/iconNext.png" />
					</div>
				</li>
				<li @click="toEditFun('sex')">
					<div class="titleBox1">性别</div>
					<div class="inputBox">
						<span>{{sex}}</span>
						<img class="iconNext" src="../../../images/mingyi/iconNext.png" />
					</div>
				</li>
				<li @click="toEditFun('bordth')">
					<div class="titleBox1">出生日期</div>
					<div class="inputBox">
						<span>{{bordth}}</span>
						<img class="iconNext" src="../../../images/mingyi/iconNext.png" />
					</div>
				...
				<li @click="toEditFun('phone')">
					<div class="titleBox1">手机号码</div>
					<div class="inputBox">
						<span>{{phone}}</span>
						<img class="iconNext" src="../../../images/mingyi/iconNext.png" />
					</div>
...
.mainBox .contentBox ul li .titleBox1 {
  float: left;
  margin-left: 0.85rem;
}
.mainBox .contentBox ul li .inputBox {
  float: right;
  margin-right: 0.85rem;
}
.mainBox .contentBox ul li .inputBox .baodanInput {
  width: 7.5rem;
}
.mainBox .contentBox ul li .inputBox .recoginBox {
  width: 3.75rem;
  height: 1.25rem;
  line-height: 1.25rem;
...
.mainBox .contentBox ul li .inputBox span {
  float: right;
  margin-right: 1.25rem;
}
.mainBox .contentBox ul li .inputBox input {
  border: none;
  text-align: right;
}
.mainBox .contentBox ul li .iconNext {
  position: absolute;
  width: 0.45rem;
  height: 0.775rem;
  top: 0.8rem;
