 <template>
  <div class="rating_page">
        <div class="titleBox">
           <div class="titleContent">患者管理</div>
            <div class="goPage" style="width: 5rem;height: 2rem;z-index: 99999;" onclick="goPageFun()">
                <img class="goPageImg" src="../../images/mingyi/goPage.png" />
            </div>
            <div class="addBtn" @click="toAddFun">
                添加
            </div>
    ...
    export default {
      data(){
        ...
        methods: {
            ...
            toAddFun(){
                console.log("LLL")
                this.$router.push('/service/addhzuser');
            }
        }
    }
</script>
